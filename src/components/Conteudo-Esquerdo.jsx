    ...
    return(
        ...
        <div className = 'wrapMenu'>
            <ul>
                ...
                <ItemMenu icone = {<AiFillHome /> } texto = " Home" /><br></br>
                <ItemMenu icone = {<AiOutlineSearch /> } texto = " Search" /><br></br>
                <ItemMenu icone = {<MdOutlineExplore /> } texto = " Explore" /><br></br>
                <ItemMenu icone = {<BsCameraReels /> } texto = " Reels" /><br></br>
                <ItemMenu icone = {<BiMessageSquareAdd /> } texto = " Messages" /><br></br>
                <ItemMenu icone = {<AiOutlineHeart /> } texto = " Notifications" /><br></br>
                <ItemMenu icone = {<RiAddBoxLine /> } texto = " Create" /><br></br>
                <ItemMenu icone = {<CgProfile /> } texto = " Profile" />
            </ul>
        </div>
        </div>
    )
